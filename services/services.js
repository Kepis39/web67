...
const sprite = document.getElementById('services-top');
const cola = document.getElementById('services-bottom');
const sprite2 = document.getElementById('services-top-2');
const cola2 = document.getElementById('services-bottom-2');
const pepsi = document.getElementById('investment-row-1');
const pepsi2 = document.getElementById('investment-row-2');
